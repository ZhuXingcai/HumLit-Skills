...
def format_gbt7714(paper: dict, index: int = 1) -> str:
    ...
    """
    if paper.get("source_category"):
        try:
            from core.source_citation import format_source_gbt7714, SOURCE_CATEGORIES
            if paper["source_category"] in SOURCE_CATEGORIES:
                return format_source_gbt7714(paper, index)
        except Exception:
            pass
