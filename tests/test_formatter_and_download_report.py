...
from core.formatter import format_apa, format_chicago, format_gbt7714, format_mla, generate_reference_list  # noqa: E402
import core.cnki  # noqa: E402
from cli._common import build_download_report  # noqa: E402
from cli.download_cmd import cmd_batch_download  # noqa: E402
...
class FormatterAndDownloadReportTests(unittest.TestCase):
    ...
    def test_batch_download_cli_falls_back_to_caj_for_pdf_button_failures(self):
        ...
        with patch.object(core.cnki, "batch_download_cnki", side_effect=fake_batch_download_cnki):
            out = io.StringIO()
